                ...
                <div className='absolute flex flex-col bottom-0 bg-gradient-to-t from-zinc-900 to-transparent w-full rounded-b-xl px-4 pt-6 py-2 gap-y-5' >
                    <div className='flex flex-col gap-y-2 ' >
                        <div className='flex items-end'>
                            <h1 className='text-2xl md:text-3xl font-medium '>{item.FirstName}</h1> <span className='text-base md:text-lg font-normal  flex items-center'><LuDot />31 yrs<LuDot /> {item.Height}</span>
                        </div>
                        ...
                        <div className={`p-4 lg:p-6 gap-y-4 flex flex-col mb-48 ${activeTab !== 'About' ? 'hidden' : ''}`} id="About" role="tabpanel" aria-labelledby="About">
                            ...
                            <div className='flex flex-col gap-y-5 md:gap-y-7'>
                                ...
                                <ProfileInfo
                                    ...
                                    text={item.HealthInformation}
                                />
                                <ProfileInfo
                                    icon={<IoIosBook />}
                                    title='Religion | Mother Toungue'
                                    text={`${item.Religion} | ${item.motherTongue}`}
                                />
                                <ProfileInfo
                                    icon={<IoIosBook />}
                                    title='Denominations'
                                    text={item.denominations}
                                />
                                <ProfileInfo
                                    icon={< MdTripOrigin />}
                                    title='Ethnic Origin'
                                    text={item.EthnicOrigin}
                                />
                                <ProfileInfo
                                    icon={<IoLocationOutline />}
                                    title='Location'
                                    text={`${item.LivingCity}, ${item.LivingState}, ${item.LivingCountry}`}
                                />
                                <ProfileInfo
                        ...
                        <div className={`p-4 lg:p-6 gap-y-4 flex flex-col mb-60 ${activeTab !== 'Family' ? 'hidden' : ''}`} id="Family" role="tabpanel" aria-labelledby="Family">
                            ...
                            <div className='flex flex-col gap-y-5 md:gap-y-7'>
                                <ProfileInfo
                                    icon={<SlUser />}
                                    title='Father Status'
                                    text={item.FatherStatus}
                                />
                                <ProfileInfo
                                    icon={<SlUserFemale />}
                                    title='Mother Status'
                                    text={item.MotherStatus}
                                />
                                <ProfileInfo
                                    icon={<AiTwotoneGold />}
                                    title='Family Type'
                                    text={item.FamilyType}
                                />
                                <ProfileInfo
                                    icon={<BsDropbox />}
                                    title='Family Tradition'
                                    text={item.FamilyTradition}
                                />
                                <ProfileInfo
                                    icon={<MdApartment />}
                                    title='Affluence Level'
                                    text={item.AffluenceLevel}
                                />
                                <ProfileInfo
                                    icon={<HiOutlineUserGroup />}
                                    title='No of Siblings'
                                    text={item.NoofSiblings}
                                />
                                <ProfileInfo
                                    icon={<IoLocationOutline />}
                                    title='Native City'
                                    text={item.NativeCity}
                                />
                            </div>
                        </div>
